<%@ Page Title="" Language="C#" MasterPageFile="~/RestaurantSite.master" AutoEventWireup="true" CodeFile="OrderHistory.aspx.cs" Inherits="OrderHistory" %>
        ...
        <fieldset class="fieldsetmain">
            ...
            <div align="center">
                <asp:GridView ID="gvorderHistory" runat="server" Width="574px" CaptionAlign="Top"
                    ...
                    <SelectedRowStyle BackColor="#7FFFD4" Font-Bold="True" ForeColor="White" />
