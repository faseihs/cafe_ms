<%@ Page Title="" Language="C#" MasterPageFile="~/RestaurantSite.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="Order" %>
        ...
        <fieldset class="fieldsetmain">
            ...
            <div id="divmain" runat="server">
                ...
                <asp:GridView ID="gvorder" runat="server" Width="574px" CaptionAlign="Top"
                    ...
                    <HeaderStyle BackColor="#7FFFD4" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="#7FFFD4" ForeColor="Black" HorizontalAlign="Center" />
                    <RowStyle BackColor="#7FFFD4" ForeColor="Black" HorizontalAlign="Center" />
            ...
            <div style="width: 100%; margin-top: 10px" align="center">
                <fieldset style="width: 550px;" align="left">
                    ...
                    <td class="auto-style4">
                        <asp:DropDownList ID="ddlDO" runat="server" Height="22px" Width="150px">
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            <asp:ListItem Value="Home Delivery">Home Delivery</asp:ListItem>
                            <asp:ListItem Value="Takeaway">Takeaway</asp:ListItem>
                        </asp:DropDownList>
                         </td>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlDO" InitialValue="0" runat="server" ErrorMessage="Please select delivery option" ForeColor="#990000"></asp:RequiredFieldValidator>
           ...
           AlternateText="ENTER DETAILS"
           ImageAlign="left"
           ImageUrl="http://smoke-51.secureweboffer.com/sites/smoke-51/offer/confirm/button_confirm.png"
